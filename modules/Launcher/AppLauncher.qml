        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                ListView {
                    ...
                    highlight: Rectangle {
                        radius: 8
                        color: theme.bgSelected //root.theme.bgSelected

                        Rectangle {
                            width: 3
                            height: 24
                            radius: 2
                            color: theme.accentPrimary //root.theme.accentPrimary
                        ...
                        RowLayout {
                            ...
                            ColumnLayout {
                                ...
                                Text {
                                    ...
                                    color: theme.launcherPrimaryText //root.selectedIndex === delegateRoot.index ? root.theme.textPrimary : root.theme.textSecondary
                                    font.pixelSize: 13
                                    font.family: "Hack Nerd Font"
